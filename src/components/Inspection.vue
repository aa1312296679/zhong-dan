...
<script>
    ...
    export default {
        ...
        data(){
          return {
              headerInfors:[{img:"/img/main-outin-list-icon.png", txt:"巡检任务信息列表", isClose:true}],
              workWrapperStyl:{width:'100.9%',height:'101.2%',left:'-3.4px',top:'-3.6px'},
              // 搜索控件
              searchControls:[
                  {txt:"巡检类型",controlType:3,options:[{txt:"安全巡检",val:0},{txt:"岗位巡检",val:1},{txt:"班组巡检",val:2},{txt:"HSE综合巡检",val:3}]},
                  ...
                  {txt:"未检巡",controlType:3,options:[{txt:"未巡检",val:0},{txt:"巡检中",val:1},{txt:"已完成",val:2}]}
              ],
              workTitles:[  // 列表头信息
                  {txt:"序号",styl:{borderTopRightRadius:"6px",borderTopLeftRadius:"6px"}},
                  {txt:"任务名称",styl:{borderTopRightRadius:"6px",borderTopLeftRadius:"6px"}},
                  {txt:"巡检类型",styl:{borderTopRightRadius:"6px",borderTopLeftRadius:"6px"}},
                  {txt:"巡检人",styl:{borderTopRightRadius:"6px",borderTopLeftRadius:"6px"}},
                  {txt:"巡检日期",styl:{borderTopRightRadius:"6px",borderTopLeftRadius:"6px"}},
                  {txt:"状态",styl:{borderTopRightRadius:"6px",borderTopLeftRadius:"6px"}},
                  {txt:"巡查结果",styl:{borderTopRightRadius:"6px",borderTopLeftRadius:"6px"}},
              ...
              workContents:[ // 列表内容信息      images/look-outinrecord-btn-highlight.png
                  {index:1,catId:12122,name:"厂区装置巡检",sex:'男',age:25,unit:'中丹化工',department:'生产部',ico:"/img/look-outinrecord-btn.png",activeIco:"/img/look-outinrecord-btn-highlight.png"},
                  {index:2,catId:23335,name:"厂区装置巡检",sex:'男',age:27,unit:'中丹化工',department:'生产部',ico:"/img/look-trail-btn.png",activeIco:"/img/look-outinrecord-btn-highlight.png"},
                  {index:3,catId:23335,name:"厂区装置巡检",sex:'男',age:27,unit:'中丹化工',department:'生产部',ico:"/img/look-trail-btn.png",activeIco:"/img/look-outinrecord-btn-highlight.png"},
                  {index:4,catId:12122,name:"厂区装置巡检",sex:'男',age:25,unit:'中丹化工',department:'生产部',ico:"/img/look-trail-btn.png",activeIco:"/img/look-outinrecord-btn-highlight.png"},
                  {index:5,catId:23335,name:"厂区装置巡检",sex:'男',age:27,unit:'中丹化工',department:'生产部',ico:"/img/look-trail-btn.png",activeIco:"/img/look-outinrecord-btn-highlight.png"},
                  {index:6,catId:23335,name:"厂区装置巡检",sex:'男',age:27,unit:'中丹化工',department:'生产部',ico:"/img/look-trail-btn.png",activeIco:"/img/look-outinrecord-btn-highlight.png"},
                  {index:7,catId:23335,name:"厂区装置巡检",sex:'男',age:27,unit:'中丹化工',department:'生产部',ico:"/img/look-trail-btn.png",activeIco:"/img/look-outinrecord-btn-highlight.png"}
              ],
